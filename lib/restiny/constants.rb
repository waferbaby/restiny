...
module Restiny
  ...
  module ManifestDefinition
    ...
    ACTIVITY_DIFFICULTY_TIER_COLLECTION = 'DestinyActivityDifficultyTierCollectionDefinition'
    ACTIVITY_FAMILY = 'DestinyActivityFamilyDefinition'
    ACTIVITY_GRAPH = 'DestinyActivityGraphDefinition'
    ACTIVITY_INTERACTABLE = 'DestinyActivityInteractableDefinition'
    ACTIVITY_LOADOUT_RESTRICTION = 'DestinyActivityLoadoutRestrictionDefinition'
    ACTIVITY_MODE = 'DestinyActivityModeDefinition'
    ACTIVITY_MODIFIER = 'DestinyActivityModifierDefinition'
    ACTIVITY_SELECTABLE_SKULL_COLLECTION = 'DestinyActivitySelectableSkullCollectionDefinition'
    ACTIVITY_SELECTABLE_SKULL_EXCLUSION_GROUP = 'DestinyActivitySelectableSkullExclusionGroupDefinition'
    ACTIVITY_SKULL_CATEGORY = 'DestinyActivitySkullCategoryDefinition'
    ACTIVITY_SKULL_SUBCATEGORY = 'DestinyActivitySkullSubcategoryDefinition'
    ...
    EQUIPABLE_ITEM_SET = 'DestinyEquipableItemSetDefinition'
    EQUIPMENT_SLOT = 'DestinyEquipmentSlotDefinition'
    EVENT_CARD = 'DestinyEventCardDefinition'
    FACTION = 'DestinyFactionDefinition'
    FIRETEAM_FINDER_ACTIVITY_GRAPH = 'DestinyFireteamFinderActivityGraphDefinition'
    FIRETEAM_FINDER_ACTIVITY_SET = 'DestinyFireteamFinderActivitySetDefinition'
    FIRETEAM_FINDER_CONSTANTS = 'DestinyFireteamFinderConstantsDefinition'
    FIRETEAM_FINDER_LABEL = 'DestinyFireteamFinderLabelDefinition'
    FIRETEAM_FINDER_LABEL_GROUP = 'DestinyFireteamFinderLabelGroupDefinition'
    FIRETEAM_FINDER_OPTION = 'DestinyFireteamFinderOptionDefinition'
    FIRETEAM_FINDER_OPTION_GROUP = 'DestinyFireteamFinderOptionGroupDefinition'
    GENDER = 'DestinyGenderDefinition'
    GLOBAL_CONSTANTS = 'DestinyGlobalConstantsDefinition'
    GUARDIAN_RANK_CONSTANTS = 'DestinyGuardianRankConstantsDefinition'
    GUARDIAN_RANK = 'DestinyGuardianRankDefinition'
    HISTORICAL_STATS = 'DestinyHistoricalStatsDefinition'
    ICON = 'DestinyIconDefinition'
    INVENTORY_BUCKET = 'DestinyInventoryBucketDefinition'
    INVENTORY_ITEM_CONSTANTS = 'DestinyInventoryItemConstantsDefinition'
    INVENTORY_ITEM = 'DestinyInventoryItemDefinition'
    ITEM_CATEGORY = 'DestinyItemCategoryDefinition'
    ITEM_FILTER = 'DestinyItemFilterDefinition'
